...
export default function Page() {
  return (
    <main className="relative flex min-h-svh w-full items-center justify-center overflow-hidden p-6 md:p-10">
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top_right,oklch(0.78_0.12_200/.28),transparent_45%),radial-gradient(circle_at_bottom_left,oklch(0.82_0.12_95/.22),transparent_40%)]" />
